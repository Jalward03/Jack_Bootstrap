...
Box::Box(glm::vec2 position, float width, float height, float orientation, glm::vec2 velocity, float mass, glm::vec4 color) : Rigidbody(BOX, position, velocity, 0, mass, 0, 0)
{
	m_height = height;
	m_width = width;
